...
description: "Retrieve the USD-base FX rate table used by CSBoard payment flows. Multiply any price_usd by the target currency rate for a local-currency price."
