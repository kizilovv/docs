...
description: "Purchase 1–10 CS2 listings by ID in a single atomic request, debited from your CSBoard balance. Requires a trading-enabled API key and a linked Steam account."
---
