...
If the price moved and you receive a `409`, the response body includes `current_total_usd` so you can decide whether to re-submit with a higher ceiling or abort:
