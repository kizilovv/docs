...
**4. Корректно обрабатывайте `409 price_moved`**

`409 price_moved` означает, что цена превысила ваш потолок — списание не было выполнено. Решайте: повторно получить листинг, обновить `max_price_usd` и повторить, или отказаться от сделки:
